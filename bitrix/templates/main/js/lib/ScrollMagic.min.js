...
!function (e, t) {
  ...
  "use strict";
  var e = function e() {};e.version = "2.0.5", window.addEventListener("mousewheel", function () {});var t = "data-scrollmagic-pin-spacer";e.Controller = function (r) {
    var o,
        s,
    ...
    };this._options = h;var O = function O(e) {
    ...
    var o,
      ...
      d.triggerHook > 0 && f.trigger("shift", { reason: "containerResize" });
        ...
        z = i.extend(r.validate, { duration: function duration(e) {
        if (i.type.String(e) && e.match(/^(\.|\d)*\d+%$/)) {
          var t = parseFloat(e) / 100;e = function e() {
  ...
  };var r = { defaults: { duration: 0, offset: 0, triggerElement: void 0, triggerHook: .5, reverse: !0, loglevel: 2 }, validate: { offset: function offset(e) {
    ...
    var t,
      ...
      if (n = n === document ? e : n, n === e) s = !1;else if (!f.DomElement(n)) return 0;t = t.charAt(0).toUpperCase() + t.substr(1).toLowerCase();var a = (_o ? n["offset" + t] || n["outer" + t] : n["client" + t] || n["inner" + t]) || 0;if (_o && s) {
      ...
      return "object" == (typeof HTMLElement === "undefined" ? "undefined" : _typeof(HTMLElement)) ? e instanceof HTMLElement : e && "object" == (typeof e === "undefined" ? "undefined" : _typeof(e)) && null !== e && 1 === e.nodeType && "string" == typeof e.nodeName;
