...
!function (e, t) {
  "function" == typeof define && define.amd ? define([], t) : "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports ? module.exports = t() : e.Rellax = t();
}(undefined, function () {
  var e = function e(t, n) {
    ...
    var o = Object.create(e.prototype),
      ...
      var e = document.createElement("div");if (null == e.style.transform) {
        var t = ["Webkit", "Moz", "ms"];for (var n in t) {
    ...
    };o.options = { speed: -2, center: !1, round: !0, callback: function callback() {} }, n && Object.keys(n).forEach(function (e) {
      o.options[e] = n[e];
    }), o.options.speed = d(o.options.speed, -10, 10), t || (t = ".rellax");var u = document.querySelectorAll(t);if (!(u.length > 0)) throw new Error("The elements you're trying to select don't exist.");o.elems = u;var f = function f(e) {
      ...
      for (var e = 0; e < o.elems.length; e++) {
        o.elems[e].style.cssText = s[e].style;
      }a = !0;
    }, function () {
